    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="..<?= route_to('aceites');?>" class="nav-link <?= (current_url() == base_url('aceites')) ? 'active' : '';?>">
              <i class="nav-icon 	fas fa-oil-can"></i>                
              <p>Aceites</p>
            </a>
          </li>     
          <li class="nav-item">
            <a href="..<?= route_to('equipos');?>" class="nav-link <?= (current_url() == base_url('equipos')) ? 'active' : '';?>">
              <i class="nav-icon 	fas fa-laptop"></i>                
              <p>Equipos</p>
            </a>
          </li>  
          <li class="nav-item">
            <a href="..<?= route_to('mobiliario');?>" class="nav-link <?= (current_url() == base_url('mobiliario')) ? 'active' : '';?>">
              <i class="nav-icon 	fas fa-couch"></i>                
              <p>Mobiliario</p>
            </a>
          </li> 
          <li class="nav-item">
            <a href="..<?= route_to('herramienta');?>" class="nav-link <?= (current_url() == base_url('herramienta')) ? 'active' : '';?>">
              <i class="nav-icon 	fas fa-tools"></i>                
              <p>Herramientas</p>
            </a>
          </li> 
          <li class="nav-item">
            <a href="..<?= route_to('mantenimiento');?>" class="nav-link <?= (current_url() == base_url('mantenimiento')) ? 'active' : '';?>">
